...
2. **Next Game**: `1-2-003-animalitos-suenan` (after site redesign).
3. **Set up Project**: Create `/games/animalitos-suenan/`
4. **Begin Implementation**: Code the game.
5. **Finalization**: Register in `games-list.json`, update master plan.
